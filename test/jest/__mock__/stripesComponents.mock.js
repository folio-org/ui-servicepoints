...
jest.mock('@folio/stripes/components', () => ({
  ...
  Button: jest.fn(({ children, buttonStyle, onClick = jest.fn() }) => (
    <button data-test-button type="button" onClick={onClick} className={buttonStyle}>
      <span>
        {children}
      </span>
    </button>
  ...
  Modal: jest.fn(({ children, label, dismissible, footer, open, ...rest }) => {
